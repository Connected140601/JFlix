...
function loadVideo(id, type, season = null, episode = null) {
  ...
  try {
    ...
    if (typeof videoUrl === 'string' && (videoUrl.startsWith('http://') || videoUrl.startsWith('https://'))) {
      ...
      videoPlayer.setAttribute('csp', `default-src 'self' https://${serverHost} https:; script-src 'self' https://${serverHost} https: 'unsafe-inline' 'unsafe-eval'; style-src 'self' https://${serverHost} https: 'unsafe-inline'; img-src https: data:; media-src https: data:; font-src https: data:; object-src 'none';`);
    } else {
      ...
      videoPlayer.setAttribute('csp', `default-src 'self' https:; script-src 'self' https: 'unsafe-inline' 'unsafe-eval'; style-src 'self' https: 'unsafe-inline'; img-src https: data:; media-src https: data:; font-src https: data:; object-src 'none';`);
    }
  } catch (e) {
