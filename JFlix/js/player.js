...
const SERVER_URLS = {
  ...
  '2embed': 'https://multiembed.mov/', // Updated to multiembed.mov
  vidsrcto: 'https://www.2embed.cc/'
};
  ...
  if (type === 'movie' || type === MEDIA_TYPES.MOVIES) {
    ...
    switch(currentServer) {
      ...
      case '2embed':
        ...
        break;
      case 'vidsrcto':
        // Server 4: VidSrc.to (now 2embed.cc)
    ...
    if (season !== null && episode !== null) {
      ...
      switch(currentServer) {
        ...
        case '2embed':
          // Server 3: multiembed.mov
          // For TV shows without season/episode, defaulting to S1E1
