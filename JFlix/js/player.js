  ...
  if (type === 'movie' || type === MEDIA_TYPES.MOVIES) {
    ...
    if (season !== null && episode !== null) {
      switch(currentServer) {
        case 'vidsrcxyz':
          // Server 1: VidSrc.xyz
          // Use query parameters for all TV types for vidsrcxyz for consistency
        ...
        case 'videasy':
          ...
          // Add color parameter using the helper function
      ...
      switch(currentServer) {
        case 'vidsrcxyz':
          // Use query parameters for all TV types for vidsrcxyz for consistency, defaulting to S1E1
