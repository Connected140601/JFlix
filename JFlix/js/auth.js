...
async function handleAccessControl(user) {
    ...
    if (user) { 
        ...
        if (premiumStatus.isPremium) {
            if (!isNoAdsPath && window.location.href !== redirectToNoAds) {
                console.log('[Auth] Premium user on main site, redirecting to NOADS.');
                window.location.href = redirectToNoAds;
                return true; 
            }
        } else {
            if (isNoAdsPath && window.location.href !== redirectToMain) {
